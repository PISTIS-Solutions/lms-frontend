    ...
    <div className="bg-white">
      <div className="bg-whtcurve bg-top bg-no-repeat h-[100%]">
        ...
        <div className="flex flex-col items-center gap-6 py-16">
          <div className="rounded-[30px] text-center bg-[#CDEFE4] px-5 py-2 text-[#15553F] font-normal text-base inline-block">
            <p>Advance Your Career with</p>
          </div>
          <h1 className="text-main text-7xl text-center max-w-[1138px] font-light">
            Expert-Led Courses and{" "}
            <span className="font-semibold italic">
              Master In-Demand Skills
            </span>
          </h1>
          <p className="text-[#484848] text-lg text-center max-w-[836px] font-normal">
        ...
        <div className="relative py-10">
          <div className="absolute left-0 top-0 h-full w-20 pointer-events-none bg-gradient-to-r from-white" />
          ...
          <div className="absolute right-0 top-0 h-full w-20 pointer-events-none bg-gradient-to-l from-white" />
        </div>
        <LandingPayment />
        <Footer />
      </div>
