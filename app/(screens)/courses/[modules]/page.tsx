      ...
      <div className="md:ml-64 ml-0 overflow-y-scroll h-screen">
        ...
        <div className="p-4">
          <span className="flex gap-1 items-center">
            <p className="text-xs md:text-sm text-main">Course Content</p>{" "}
            <ChevronRight className="text-main" />{" "}
            <p className="text-xs md:text-sm text-[#9C9C9C]">Modules</p>{" "}
          </span>
          <div className="md:grid block grid-cols-10 gap-x-2 my-2 ">
            <div className="bg-white col-span-7 p-2 rounded-[8px] shadow-sm">
              <h1 className="md:text-2xl text-xl text-main py-2">{moduleData.title}</h1>
